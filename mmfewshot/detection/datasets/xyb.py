...
class FewShotXYBDataset(BaseFewShotDataset, CocoDataset):
...
@DATASETS.register_module()
class FewShotXYBCopyDataset(FewShotXYBDataset):
...
@DATASETS.register_module()
class FewShotXYBDefaultDataset(FewShotXYBDataset):
    ...
    def ann_cfg_parser(self, ann_cfg: List[Dict]) -> List[Dict]:
        ...
        return super(FewShotXYBDataset, self).ann_cfg_parser(new_ann_cfg)
