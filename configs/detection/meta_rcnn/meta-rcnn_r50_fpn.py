...
model = dict(
    ...
    backbone=dict(type='ResNetWithMetaConv', depth=50, frozen_stages=4),
    neck=dict(out_channels=256),   # default: out_channels=256
    rpn_head=dict(
        in_channels=256,   #
    ...
    roi_head=dict(
        ...
        shared_head=dict(
            type='MetaRCNNFPNAddLayer', init_cfg=None),
        bbox_head=dict(
            _delete_=True,
            type='MetaBBoxHead',
            with_avg_pool=False,
